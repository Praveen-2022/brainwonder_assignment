...
const jsonData = [
  {
    ...
    "Careers": [
      "Leader", "Entrepreneur", "Direct marketing", "Insurance", "Politician", "Public relations"
    ],
    "Training Methods": [
  ...
  },
  {
    ...
    "Careers": [
      "Manager", "Director", "Secretary", "Supervisor", "Special assistant"
    ],
    "Training Methods": [
      "Event management", "Group activities", "Planning", "Reviews and Discussions"
    ]
  },
  {
    ...
    "Careers": [
      "Religious leader", "Psychiatrist", "Counselor", "Expert or Scholar", "Pastor", "Analyst"
    ],
    "Training Methods": [
      "Psychology", "Reflect on How to Self-Reflect", "Meditation", "Religious activities", "Read books on philosophy and classics"
    ]
  },
  {
    ...
    "Careers": [
      "Inventors", "Scriptwriter", "Novelist", "Author", "Comic artist"
    ],
    "Training Methods": [
      "Writing essays", "Creativity training", "Storytelling", "Keeping a diary", "Drawing"
    ]
  },
  {
    ...
    "Careers": [
      "Mathematician", "Statistician", "Accountant", "Economist", "Auditor"
    ],
    "Training Methods": [
  ...
  },
  {
    ...
    "Careers": [
      "Designer", "Space planner", "Architect", "Engineer", "Cartographer"
    ],
    "Training Methods": [
  ...
  },
  {
    ...
    "Careers": [
      "Lawyer", "Orator", "Business expert", "Journalist", "Broadcaster", "Presenter", "Emcee/Master of Ceremonies"
    ],
    "Training Methods": [
      "Oratorical class",
      "Language study",
  ...
  },
  {
    ...
    "Careers": [
      "Actor/Actress", "Athlete", "Mechanic", "Martial artist", "Arts practitioner", "Surgeon", "Dancer"
    ],
    "Training Methods": [
      "Body movements",
      "Crafts",
...
const ComponentFive = () => {
  return (
    ...
    <div key={index} className="border border-gray-400 rounded-2xl my-6">
      {/* Header */}
      <div className="p-4 bg-sky-100 rounded-t-2xl">
        <h1 className="font-semibold text-xl text-gray-800">{item.Name}</h1>
      </div>

      {/* Grid Layout */}
      <div className="grid grid-cols-3">
        {/* Specific Performance */}
        <div className="border-r-2 mx-4 my-6 border-gray-500">
        ...
        {/* Careers */}
        <div className="border-r-2 border-gray-500 mx-4 my-6">
